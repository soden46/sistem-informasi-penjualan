        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <img class="img-fluid"
                            src="{{ url('assets/upload/images/barang/' . $barang->foto ?? 'Tidak ada Foto') }}"
                            alt="">
                    </div>
                    <div class="col-lg-6">
                        <div class="row pt-2 pb-4">
                            ...
                            <div class="col-md-6">
                                <div class="pt-4">
                                    <label class="form-label fw-bold" for=""><i class="bi bi-cash"></i>
                                        Harga</label>
                            ...
                            <div class="pt-2" id="beli" style="display: none;">
                                ...
                                <div class="mb-3 pt-2">
                                    ...
                                    <div class="row pt-2 pb-2">
                                        <label for="nama_barang" class="col-lg-4 col-sm-4 form-label fw-bold"> <i
                                                class="fa-solid fa-barcode"></i> Nama Barang</label>
                                    ...
                                    <div class="row pt-2 pb-2">
                                        <label for="lokasi_pengiriman" class="col-lg-4 col-sm-4 form-label fw-bold"> <i
                                                class="bi bi-geo-alt"></i> Lokasi Pengiriman</label>
                                        <div class="col-lg-8 col-sm-8">
                                            <input type="text" name="lokasi_pengiriman"
                                                placeholder="Masukan Lokasi / Alamat Pengiriman" id="lokasi_pengiriman"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row pt-2 pb-2">
                                        <label for="jumlah" class="col-lg-4 col-sm-4 form-label fw-bold"> <i
                                                class="bi bi-cart-plus"></i> Jumlah</label>
                                        <div class="col-lg-8 col-sm-8">
                                            <div class="handle-counter" id="handleCounter" onclick="sum();">
                                                <button class="counter-minus btn btn-primary">-</button>
                                                <input type="number" name="jumlah" id="jumlah"
                                                    class="form-control form-control-custom" min="1">
                                    ...
                                    <div class="row pt-2 pb-2">
                                        <label class="col-lg-4 col-sm-4 form-label fw-bold"> <i class="bi bi-cash"></i>
                                            Total Biaya</label>
                                        <div class="col-lg-8 col-sm-8">
                                            <span style="font-weight: bold; font-size: x-large;">Rp <span
                                                    id="totalDisplay">0</span></span>
                                            <input type="text" id="totalInput" name="total"
                                                class="form-control form-control-custom" hidden>
                                        </div>
                                    </div>
                                    <div class=" d-flex justify-content-center">
