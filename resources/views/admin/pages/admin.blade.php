                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#reset-{{ $item->id }}"><i class="bi bi-lock"></i> Reset</a>
                    ...
                    <div class="modal fade" id="create" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form action="{{ url('create-data-user') }}" method="post" enctype="multipart/form-data">
                                    @method('post')
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        <div class="row pt-2">
                                            <label for="name" class="col-sm-2 col-form-label">Nama
                                                Lengkap</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ $item->nama }}" placeholder="Masukan Nama Lengkap">
                                            </div>
                                            @error('name')
                                            <div class="text-danger">
                                                {{ $message }}
                                        ...
                                        <div class="row pt-2">
                                            <label for="username" class="col-sm-2 col-form-label">Username</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" value="{{ $item->username }}" placeholder="username">
                                                @error('username')
                                                <div class="text-danger">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="row pt-2">
                                            <label for="email" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" min="0" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ $item->email }}" placeholder="email">
                                                @error('email')
                                                <div class="text-danger">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="d-flex align-items-center flex-column">
                                                    <img src="{{ url('assets/admin/images/users/' . $item->photo) }}" alt="" class="img-fluid" style="height: 200px; width: auto; border-radius: 10px">
