                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center gap-2">
                                                                ...
                                                                <a href="javascript:void(0);" class="btn btn-warning btn-sm"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#edit-{{ $item->id_user }}"><i
                                                                        class="bi bi-pencil"></i> Ubah</a>
                                                                <a href="javascript:void(0);" class="btn btn-success btn-sm"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#reset-{{ $item->id_user }}"><i
                            ...
                            <div class="modal fade" id="reset-{{ $item->id_user }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('reset-data-user/' . $item->id_user) }}" method="post">
                                            @method('put')
                                            @csrf
                                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="delete-{{ $item->id_user }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('delete-data-user/' . $item->id_user) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="edit-{{ $item->id_user }}" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('update-data-user/' . $item->id_user) }}" method="post"
                                            enctype="multipart/form-data">
                                            @method('put')
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="row pt-2">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="role" id=""
                                                            class="form-select @error('role') is-invalid @enderror">
                                                            <option value="">--Pilih--</option>
                                                            <option {{ $item->role == 'owner' ? 'selected' : '' }}
