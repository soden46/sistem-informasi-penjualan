                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format($invoice->harga * $invoice->jumlah) }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th colspan="4" class="text-end">Total</th>
                                                            <th>{{ number_format($invoice->harga * $invoice->jumlah) }}
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <div class="d-flex justify-content-end">
                                                    <a href="{{ url('download-invoicec-/' . $invoice->id) }}" class="btn btn-success"><i class="bi bi-download"></i> Unduh
                                                        Incoice</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-3">
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-file-earmark-text"></i>
                                                ...
                                                @if ($invoice->status == '0')
                                                <form action="{{ url('confirm-transaksic/' . $invoice->id) }}" method="post" enctype="multipart/form-data">
                                                    @method('put')
                                                    @csrf
