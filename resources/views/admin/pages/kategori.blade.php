                         ...
                         <div class="d-flex">
                             ...
                             <div class="position-relative overflow-hidden bg-light d-flex flex-column justify-content-center w-100 ps-4"
                                 ...
                                 <div class="d-flex gap-2">
                                     @if ($item->stok > 0)
                                         <span><i class="fa-solid fa-boxes-stacked"></i> Stok:
                                             {{ $item->stok }}</span>
                                     @endif
                                 ...
                                 <div class="team-social">
                                     @if ($item->stok > 0)
                                         <a class="btn btn-dark mx-1"
                                             href="{{ url('detail-mebel/' . $item->id_barang) }}"><i
                                                 class="bi bi-file-earmark-plus"></i> Pesan</a>
                                     @else
                                         <button class="btn btn-warning disabled mx-1" href="">Tidak
                                             Tersedia</button>
                                     @endif
                                     <a class="btn btn-dark mx-1" href="{{ url('detail-mebel/' . $item->id_barang) }}"
                                         id="id" name="id"><i class="bi bi-info-circle"></i>
                                         Detail</a>
                                 </div>
                             </div>
                         </div>
